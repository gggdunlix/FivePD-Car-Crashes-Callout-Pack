...
[CalloutProperties("Hit and Run (Normal)", "GGGDunlix", "3.0.0")]
public class HitAndRunNormal : FivePD.API.Callout
{
    ...
    public HitAndRunNormal()
    {
        ...
        CalloutDescription = "A vehicle collision has occurred, and one of the drivers fled. Respond in Code 2 High.";
        ResponseCode = 2;
        StartDistance = 150f;
    }
